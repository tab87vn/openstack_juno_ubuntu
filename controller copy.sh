...
ca_certs = /etc/keystone/ssl/certs/ca.pem
cert_subject=/C=US/ST=Unset/L=Unset/O=Unset/CN=${MNG_IP} # EXT_IP
#cert_subject=/C=US/ST=Unset/L=Unset/O=Unset/CN=${EXT_IP}
...
[keystone_authtoken]
identity_uri = https://${MNG_IP}:35357 #${EXT_IP}
admin_tenant_name = service
admin_user = glance
admin_password = glance
insecure = True
...
# Create database
MYSQL_HOST=${MNG_IP} #${EXT_IP}
GLANCE_HOST=${MNG_IP} #${EXT_IP}
KEYSTONE_ENDPOINT=${MNG_IP} #${EXT_IP}
SERVICE_TENANT=service
NOVA_SERVICE_USER=nova
NOVA_SERVICE_PASS=nova
